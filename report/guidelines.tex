...
So as a result, the current recall of the lexical type method is not yet more than about 10\%. The precision of recognized symptoms is very high because of the strict text matches, but still only 22\% of the symptoms mentioned in the target text are recognized as such.
