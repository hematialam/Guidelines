...
\caption{Accuracies of Extraction Modules}
\end{figure}
...
The current recall of the lexical type apparatus is about 22\% for a small sample. On the other hand, the precision of recognized symptoms is very high because of the strict match rules. We believe we can improve the recall by adding a rules to match conjunctions, but to do this we are embedding a more complete logic engine.
